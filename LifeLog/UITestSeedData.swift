...
enum UITestSeedData {
    ...
    static func install(in container: ModelContainer) throws {
        ...
        func visit(_ start: Int, _ end: Int?, _ place: String, _ activity: String, _ source: String = "automatic", _ confidence: String? = "learned") {
            ...
            context.insert(Visit(arrival: arrival, departure: departure, latitude: place == "Home" ? home.latitude : shops.latitude, longitude: place == "Home" ? home.longitude : shops.longitude, placeName: place, inferredActivity: activity, userActivity: activity, source: source, recognitionConfidence: confidence))
        }
