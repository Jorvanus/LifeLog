...
- [ ] Two files are still doing too much: `ActivityLocationPolicy` (819 lines, grown from 702) mixes stay resolution, journey detection, commute matching and confidence scoring; `ActivityImportActor` (521) mixes HealthKit reading, Core Motion reading and writing. Both would split along seams that already exist.
